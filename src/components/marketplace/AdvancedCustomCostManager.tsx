...
const AdvancedCustomCostManager: React.FC<AdvancedCustomCostManagerProps> = ({ 
  customCosts, 
  onAddCost, 
  onUpdateCost,
  onRemoveCost 
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-3 overflow-x-auto pb-2">
            ...
            <div className="md:col-span-2 min-w-[120px]">
              ...
              <input
                ...
                onChange={(e) => handleCustomCostChange('value', parseFloat(e.target.value) || 0)}
                min={0}
...
export default AdvancedCustomCostManager;