...
import FormField, { TextInput, NumberInput } from '../common/FormField';
...
const AddCustomCostForm: React.FC<AddCustomCostFormProps> = ({ onAddCost }) => {
...
export default AddCustomCostForm;