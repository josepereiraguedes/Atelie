...
import { useLocalDatabase, MarketplacePricingConfig } from '../../contexts/LocalDatabaseContext';
...
const MarketplaceList: React.FC<MarketplaceListProps> = ({ onEdit, onDelete }) => {
