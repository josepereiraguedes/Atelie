...
const PhysicalSalesPricingCalculator: React.FC = () => {
  ...
  const handleParameterChange = (param: keyof typeof currentFormula.parameters, value: number) => {
        ...
        <div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                type="number"
                value={currentFormula.parameters.margin}
                onChange={(e) => handleParameterChange('margin', Number(e.target.value))}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                min="0"
                step="0.1"
              />
            ...
            <div>
              ...
              <input
                type="number"
                value={currentFormula.parameters.fixedFee}
                onChange={(e) => handleParameterChange('fixedFee', Number(e.target.value))}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                min="0"
                step="0.01"
              />
            ...
            <div>
              ...
              <input
                type="number"
                value={currentFormula.parameters.percentageFee}
                onChange={(e) => handleParameterChange('percentageFee', Number(e.target.value))}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                min="0"
                step="0.1"
              />
            ...
            <div>
              ...
              <input
                type="number"
                value={currentFormula.parameters.minProfit}
                onChange={(e) => handleParameterChange('minProfit', Number(e.target.value))}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                min="0"
                step="0.01"
              />
