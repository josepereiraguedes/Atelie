...
import { useLocalDatabase, Client, ClientQuote, Product, ClientQuoteItem, Transaction } from '@/core/contexts/LocalDatabaseContext';
...
const ClientQuoteDetails: React.FC = () => {
  ...
  console.log('Renderizando ClientQuoteDetails com id:', id);
